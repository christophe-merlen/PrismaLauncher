...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/christophe-merlen/PrismaLauncher/releases.atom',
        success: (data) => {
...
function populateSettingsUpdateInformation(data){
    if(data != null){
        settingsUpdateTitle.innerHTML = `Nouvelle ${isPrerelease(data.version) ? 'Avant-première' : 'Sortie'} Disponible`
