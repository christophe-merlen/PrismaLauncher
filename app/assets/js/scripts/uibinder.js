    ...
    if(selectedAcc != null){
        ...
        if(!val){
            ...
            setOverlayContent(
                ...
                `Nous n'avons pas pu actualiser la connexion pour <strong>${selectedAcc.displayName}</strong>. Veuillez ${accLen > 0 ? 'sélectionner un autre compte ou ' : ''} reconnectez-vous.`,
                'Connexion',
